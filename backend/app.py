...
# @app.route("/addmatch")
def addmatch():
    data=pd.read_csv("/Users/akshat/Documents/web_development/cricket-data-analysis/t20_csv_files/dim_match_summary.csv")
    cur=db.cursor()
    for j in range(45):
        l=[]
...
def addplayers():
    data=pd.read_csv("/Users/akshat/Documents/web_development/cricket-data-analysis/t20_csv_files/dim_players.csv")
    cur=db.cursor()
    for j in range(219):
        l=[]
        for i in data.iloc[j]:
...
def addbatsman():
    data=pd.read_csv("/Users/akshat/Documents/web_development/cricket-data-analysis/t20_csv_files/fact_bating_summary.csv")
    for j in range(699):
        l=[]
        for i in data.iloc[j]:
            l.append(i)
...
def addbowlers():
    data=pd.read_csv("/Users/akshat/Documents/web_development/cricket-data-analysis/t20_csv_files/fact_bowling_summary.csv")
    for j in range(500):
        l=[]
        for i in data.iloc[j]:
            l.append(i)
...
def allrounder():
    ...
    for i in d:
        ...
        # print(j)
        try:
            di={'id':id,'Name':i[0],'Bowling Style':style[0][0],'Batting Style':style[0][1],"Innings Batted": i[1],'Runs':i[2],"Strike Rate": i[3],"Batting Average":runs[0][0]/out[0][0],"Innings Bowled":j[0][0],'Balls Bowled':j[0][1],"Wickets":j[0][2],'Economy':j[0][4],'Bowling Strike Rate':j[0][5],'Maidens':j[0][3]}
            res.append(di)
        except:
            continue
        id=id+1
